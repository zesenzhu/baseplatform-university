                ...
                <div className="safe-setting-content">
                    ...
                    <div className={`safe-pwd-wrapper safe-item-wrapper ${HasSetPwd?'set':''}`}>
                        ...
                        <div className="safe-pwd-setting safe-item-setting" ref="pwd-content">
                            ...
                            <div className="pwd-strong-wrapper" style={{display:this.state.PwdStrongShow?'block':'none'}}>
                ...
                <Modal
                    ...
                    <div className="ModalContent">
                        ...
                        <div className="edit-pwd clearfix">
                            ...
                            <Tooltip placement="right" getPopupContainer={triggerNode => triggerNode.parentNode} visible={editQuestionsModal.pwdTipsShow} title={editQuestionsModal.pwdTips}>
