...
const TeacherCustomData = (
  ...
  switch (actions.type) {
    ...
    case TeacherCustomActions.STU_SET_ALL_CUSTOM_DATA:
      let AllData = Object.assign({},state.AllData,{ ...actions.data })
      return Object.assign({}, state, { AllData:AllData });
      case TeacherCustomActions.STU_SET_COMBINE_NAME_DATA:
