...
componentWillReceiveProps(nextProps){
  const { dispatch, Student } = nextProps;
    let WebData = Student.WebsiteData;
  ...
  componentWillMount() {
    ...
    let PeriodList = Student.TeacherCustomData.PeriodList;
    let newPeriodList = [];
    let Period = [];
      ...
      <div className="AddWebsiteCustom" id="AddWebsiteCustom">
        <div className="row clearfix">
          ...
          <Tips
            ...
            visible={Student.TeacherTipsVisible.WebNameTipsVisible}
        ...
        <div className="row clearfix">
          ...
          <Tips
            overlayClassName="tips"
            visible={Student.TeacherTipsVisible.WebAddressTipsVisible}
