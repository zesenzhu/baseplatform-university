const defaultIntroduce = {
  dark_blue: {
    ...
    list: [
      {
        title: "个性化应用",
        describe: "可定制个性化的功能和资源，构建专属的应用空间",
      },

      {
        title: "一体化平台",
        describe: "统一的操作习惯，互通的应用数据，一站式学习和办公",
      },

      {
        title: "海量学科资源",
        describe: "丰富的网络资源，多样的应用模式，备课和学习更高效",
      },

      {
        title: "多终端支持",
        describe: "适用于PC、手机和平板，不同场景随心使用",
      },
    ],
  },
  ...
  ai_school: {
    ...
    list: [
      {
        title: "个性化校园办公",
        describe: "可定制个性化应用,为老师/管理员提供专属的个人办公平台",
      },

      {
        title: "节能提效",
        describe:
          "物联网管控,节能降耗提效,营造安全、绿色、高效、智能的校园环境",
      },

      {
        title: "教学管理多端应用",
        describe:
          "全面覆盖教、学、管理各类信息化平台,同时适用于PC端、手机App、小程序",
      },

      {
        title: "一体化设计",
        describe: "统一认证,数据互通,智能联动的校园信息化平台",
      },
    ],
  },
    ...
    case "INTRODUCE_CHANGE":
      switch (actions.data.skin) {
        case "dark_blue":
          return {
            ...state,
            dark_blue: { ...state.dark_blue, active: actions.data.activeIndex },
          };

        case "dark_tech":
          return {
            ...state,
            dark_tech: { ...state.dark_tech, active: actions.data.activeIndex },
          };

        case "ai_school":
          return {
            ...state,
            ai_school: { ...state.ai_school, active: actions.data.activeIndex },
          };

        case "ai_exam":
          return {
            ...state,
            ai_exam: { ...state.ai_exam, active: actions.data.activeIndex },
          };
        ...
        case "ai_practice":
          return {
            ...
            ai_practice: {
              ...state.ai_practice,
              active: actions.data.activeIndex,
            },
          };
