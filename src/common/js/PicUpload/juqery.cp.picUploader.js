(function ($) {
    ...
    $.fn.extend({
        ...
        "picUploader": function (options) {
            ...
            if (_up_obj.crop) {
                ...
                $(".up_tip_container p").text("上传要求:2M以内JPG/JPEG/GIF/BMP/PNG格式。");
            }
    ...
    function _userPhoto_getCurImgPath() {
        ...
        if (_up_obj.perviewImgUrl === '') {
            ...
            tempResult = _up_obj.curImgPath.substr(_up_obj.curImgPath.lastIndexOf("/UserInfo/") + 1);
            ...
            tempResult = _up_obj.perviewImgUrl.substr(_up_obj.perviewImgUrl.lastIndexOf("/UserInfo/") + 1);
            index = tempResult.indexOf("?");
            return index > -1 ? tempResult.substring(0, tempResult.indexOf("?")) : tempResult;
        }
    }
