          ...
          if (SubjectID !== false) {
            if (SubjectID !== "all") {
              ...
              if (
                ...
                dispatch({ type: SET_SUBJECTID, College: subject?subject:{value:0,title:'全部学院'},Group:subject?subject.value?GroupList[subject.value]:{value:0,title:'全部教研室'}:{value:0,title:'全部教研室'} });
              } else {
