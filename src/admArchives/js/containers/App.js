        ...
        if (
          ...
          if (handleRoute) {
            ...
            if (handleRoute === "Student") {
                ...
                dispatch(
                  actions.UpDataState.GetTeacherToPage_univ(
                    "/GetTeacherToPage_univ?SchoolID=" +
                      ...
                      : DataState.SubjectTeacherMsg.CollegeArray[userMsg.CollegeID],
                    userMsg.UserClass === '1'||userMsg.UserClass === '2'
                      ? { value: 0, title: "全部教研室" }
              ...
              if ((userMsg.UserType === '0'&&(userMsg.UserClass === '3'||userMsg.UserClass === '4'))) {
                dispatch(
                ...
                dispatch({ type: actions.UpUIState.APP_LOADING_CLOSE });
              } else if (userMsg.UserType === '0'&&(userMsg.UserClass === '1'||userMsg.UserClass === '2')||(userMsg.UserType === '7'&&userMsg.UserClass === '2')) {
                dispatch(
