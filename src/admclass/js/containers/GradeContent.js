...
class GradeContent extends Component {
  ...
  delClass({ GradeID,ClassID,CollegeID, Event }) {
    ...
    dispatch(
      AppAlertActions.alertQuery({
        title: "您要删除该班级么？",
        ok:   this.delClassActions.bind(this, {
            GradeID,
            CollegeID,
            ClassID
          })
  ...
  delClassActions({ ClassID, GradeID ,CollegeID}) {
    const { dispatch, DataState } = this.props;
    ...
    UpDataState.delClassPost({
      ...
      if (data === "success") {
        ...
        dispatch(SearchActions.SchoolClassSearch(AllGradePreview.SearchKey,AllGradePreview.ClassInfo.PageIndex));
      ...
      <Loading tip="加载中..." spinning={GradeLoading.show} size="large">
        ...
        <ContentWrapper>
          <div className="search-wrapper clearfix">
            <Search
              width={360}
              CancelBtnShow={AllGradePreview.CancelBtnShow}
          ...
          {AllGradePreview.ClassContentShow ? (
            ""
          ) : AllGradePreview.IsMajor ? (
            <React.Fragment>
              <Statistics
                classNum={AllGradePreview.Class}
                teacherNum={AllGradePreview.CourseTecher}
                studentNum={AllGradePreview.Student}
              ></Statistics>
            ...
            <React.Fragment>
              ...
              <PartData
                CollegeClick={this.CollegeClick.bind(this)}
                type="college"
                Part={AllGradePreview}
            ...
            <React.Fragment>
              <Loading spinning={AllGradePreview.ClassLoading}>
                <PartData
                  ...
                  Part={AllGradePreview.ClassInfo}
                ...
                <PagiNation
                  ...
                  current={AllGradePreview.ClassInfo.PageIndex+1}
                  total={AllGradePreview.ClassInfo.Total}
                ></PagiNation>
              </Loading>
            </React.Fragment>
          ) : (
