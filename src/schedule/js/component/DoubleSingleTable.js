...
class DoubleSingleTable extends Component{
    ...
    render() {
        ...
        return (
            ...
            <Table id="tb" ref="table" columns={Columns} bordered dataSource={dataSource} pagination={false} scroll={{x:1120,y:window.innerHeight-200}} onRow={record=>{return { onClick:onClickRow(record) } }}>
