...
class TeacherClassCharge extends Component {
  ...
  render() {
    ...
    return (
      <div className="teacher-class-charge-wrapper">
        <ClassTab
          ClassChange={this.ClassChange.bind(this)}
          ClassList={ClassCharge.Class}
          ActiveID={ClassCharge.ActiveClassID}
        ></ClassTab>
