...
const TEACHER_STUDENT_INFO_EDITOR_STUDENT_ID_CHANGE =
...
//loading
const TEACHER_STUDENT_INFO_MODAL_LOADING_SHOW =
  "TEACHER_STUDENT_INFO_MODAL_LOADING_SHOW";

const TEACHER_STUDENT_INFO_MODAL_LOADING_HIDE =
...
const TEACHER_STUDENT_INFO_MODAL_CLASS_LIST_UPDATE =
  "TEACHER_STUDENT_INFO_MODAL_CLASS_LIST_UPDATE";

const TEACHER_STUDENT_INFO_MODAL_CLASS_DROP_SHOW =
  "TEACHER_STUDENT_INFO_MODAL_CLASS_DROP_SHOW";

const TEACHER_STUDENT_INFO_MODAL_CLASS_DROP_HIDE =
  "TEACHER_STUDENT_INFO_MODAL_CLASS_DROP_HIDE";

const TEACHER_STUDENT_INFO_MODAL_CLASS_NANE_ID_UPDATE =
  "TEACHER_STUDENT_INFO_MODAL_CLASS_NANE_ID_UPDATE";

const TEACHER_STUDENT_INFO_MODAL_CLASS_DROP_CHANGE =
  "TEACHER_STUDENT_INFO_MODAL_CLASS_DROP_CHANGE";

//输入变化

const TEACHER_STUDENT_INFO_MODAL_USER_ID_CHANGE =
  "TEACHER_STUDENT_INFO_MODAL_USER_ID_CHANGE";

const TEACHER_STUDENT_INFO_MODAL_USER_NAME_CHANGE =
  "TEACHER_STUDENT_INFO_MODAL_USER_NAME_CHANGE";

const TEACHER_STUDENT_INFO_MODAL_ID_CARD_CHANGE =
  "TEACHER_STUDENT_INFO_MODAL_ID_CARD_CHANGE";

const TEACHER_STUDENT_INFO_MODAL_ADDRESS_CHANGE =
  "TEACHER_STUDENT_INFO_MODAL_ADDRESS_CHANGE";

const TEACHER_STUDENT_INFO_MODAL_MAIL_CHANGE =
  "TEACHER_STUDENT_INFO_MODAL_MAIL_CHANGE";

const TEACHER_STUDENT_INFO_MODAL_PHONE_CHANGE =
  "TEACHER_STUDENT_INFO_MODAL_PHONE_CHANGE";

//提示消失和出现

const TEACHER_STUDENT_INFO_MODAL_ERROR_TIPS_SHOW =
  "TEACHER_STUDENT_INFO_MODAL_ERROR_TIPS_SHOW";

const TEACHER_STUDENT_INFO_MODAL_ERROR_TIPS_HIDE =
  "TEACHER_STUDENT_INFO_MODAL_ERROR_TIPS_HIDE";

//下拉菜单发生变化

const TEACHER_STUDENT_INFO_MODAL_SEX_CHANGE =
  "TEACHER_STUDENT_INFO_MODAL_SEX_CHANGE";

const TEACHER_STUDENT_INFO_MODAL_CLASS_CHANGE =
  "TEACHER_STUDENT_INFO_MODAL_CLASS_CHANGE";

//将资源服务器地址放到redux上

const TEACHER_STUDENT_INFO_MODAL_FTP_SERVER_UPDATE =
...
const ModalInit = () => {
  return (dispatch, getState) => {
    ...
    if (EditorStudentID) {
      ApiActions.GetUserDetail({ UserID: EditorStudentID, dispatch }).then(
        (data) => {
          let Gender = "保密";
          ...
          if (data) {
            ...
            if (Class.length > 1) {
              ...
              dispatch({
                type: TEACHER_STUDENT_INFO_MODAL_CLASS_LIST_UPDATE,
                data: Classes,
              });
            } else {
              ...
              dispatch({
                type: TEACHER_STUDENT_INFO_MODAL_CLASS_NANE_ID_UPDATE,
                data: {
            ...
            dispatch({
              type: TEACHER_STUDENT_INFO_MODAL_INIT,
              data: {
                UserNameValue: UserName,
                SexDrop,
                IDCardValue: IDCardNo,
    ...
    if (IDOk && NameOk && IDCardOk && TelOk && MailOk && AddressOk) {
      if ($("#picUpload").picUploader.uploadSubmit()) {
        ...
        if (EditorStudentID) {
          ...
          ApiActions.EditStudent({
            UserID: EditorStudentID,
            UserName: UserNameValue,

            Gender: SexDrop.title,
            classID,
            PhotoPath,

            IDCardNo: IDCardValue,
            Email: MailValue,
            ...
            if (data === 0) {
              dispatch(
                AppAlertActions.alertSuccess({ title: `修改学生信息成功` })
              );
      ...
      if (!IDOk) {
        if (UserIDValue) {
          ...
          dispatch({
            type: TEACHER_STUDENT_INFO_MODAL_ERROR_TIPS_SHOW,
            data: { type: "ID", title: "学号应由1-24位字母与数字组成" },
          });
        } else {
        ...
        if (UserNameValue) {
          ...
          dispatch({
            ...
            data: {
              type: "Name",
              title:
                "姓名应由1-20位的汉字/字母/数字/下划线/空格组成（首尾不允许空格）",
            },
          });
        } else {
      ...
      if (!IDCardOk) {
        ...
        dispatch({
          type: TEACHER_STUDENT_INFO_MODAL_ERROR_TIPS_SHOW,
          data: { type: "IDCard", title: "身份证格式错误" },
        });
      }
      ...
      if (!TelOk) {
        ...
        dispatch({
          type: TEACHER_STUDENT_INFO_MODAL_ERROR_TIPS_SHOW,
          data: { type: "Phone", title: "电话应由数字及-/组成" },
        });
      }
      ...
      if (!AddressOk) {
        ...
        dispatch({
          type: TEACHER_STUDENT_INFO_MODAL_ERROR_TIPS_SHOW,
          data: { type: "Address", title: "家庭住址格式错误" },
        });
      }
    }
  };
